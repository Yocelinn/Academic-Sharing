  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="paperList" border stripe>
        ...
        <el-table-column label="发起人" prop="paperName"></el-table-column>
      ...
      <el-dialog title="查看信息" v-model="infoVisible" width="50%" destroy-on-close>
        <el-form :model="infoForm" ref="infoFormRef" label-width="70px">
          <el-form-item label="发起人" prop="paperName">
            <el-input v-model="infoForm.paperName" disabled></el-input>
          </el-form-item>
      ...
      <el-dialog title="处理" v-model="handleVisible" width="50%" destroy-on-close>
        <el-form :model="handleForm" ref="handleFormRef" label-width="70px">
          <el-form-item label="发起人" prop="paperName">
            <el-input v-model="handleForm.paperName" disabled></el-input>
          </el-form-item>
          <el-form-item label="时间" prop="time">
